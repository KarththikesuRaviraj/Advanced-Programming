...
const Reservation = () => {
  ...
  const outlets = [
    { value: 'Jaffna Town', label: 'Jaffna Town' },
    { value: 'Chankanai', label: 'Chankanai' },
    { value: 'Udupiddy', label: 'Udupiddy' },
    { value: 'Vaddukoddai', label: 'Vaddukoddai' },
    { value: 'Point Pedro', label: 'Point Pedro' },
    { value: 'Nelliady', label: 'Nelliady' },
    { value: 'Tellippalai', label: 'Tellippalai' },
    { value: 'Karainagar', label: 'Karainagar' },
